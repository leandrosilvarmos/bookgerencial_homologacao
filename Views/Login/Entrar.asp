...
<head>
    ...
    <link href="/_mvc/Content/css/cookie-consent.css" rel="stylesheet">
...
<body class="gray-bg">
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <img src="/Content/img/logo_hesap.png" style="width: 100px;" />
            <img src="/Content/img/logo_hls.png" style="width: 100px;" />
        </div>
    </div>

    <script src="/_mvc/Content/js/cookie_consent.js"></script>
