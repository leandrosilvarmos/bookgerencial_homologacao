...
'==================================================================================
'
'   Title (string): Título do Sistema
'
'   CdSistema (int): Código do Sistema
'       De acordo com registro no banco - tabela 'SISTEMA', campo 'CD_SISTEMA'
'
'   Layout (string): Caminho físico do arquivo de layout da página
'       Se não definido utiliza caminho especificado na constante 'defaultLayout'
'
'   IsTest (boolean): Modo de teste
'       True - Base de testes; tratamento de erros desabilitado
'       False (default) - Base de produção; tratamento de erros habilitado
'
'   IsNavigationFile (boolean): Itens de navegação (menus e links) do arquivo
'       True - Carregar itens de navegação do arquivo (\Json\navigation.json)
'       False (default) - Carregar itens de navegação do banco de dados (procedure 'OBTER_CONTROLLERS_ACTIONS_SPR')   
'
'   IsVerificarPermissoes (boolean): Verificação de Permissões
'       True (default) - Habilitar a verificação de permissões, permitir acesso somente se tiver permissão
'       False - Desabilitar verificação de permissões, permitir acesso sem ter permissão
'
'   IsVerificarLogin (boolean): Verificação de Login (Session("CdUsuario"))
'       True (default) - Habilitar a verificação de login, permitir acesso somente se logado
'       False - Desabilitar verificação de login, permitir acesso sem estar logado
'
'   IsCookie (boolean): Verificar o uso de Cookies
'       True - Habilitar o uso de Cookies
'       False - Desabilitar o uso de Cookies
'
'   LoginPage (string): Caminho virtual da página de login
'       Se não definido utiliza caminho especificado na constante 'defaultLogin'
'
'   EmailTest (string): Endereço de email para envio de emails no modo teste (IsTest = True)
'       Se não definido utiliza email especificado na constante 'defaultEmailTest'
'
'   CookieName (string): Nome do cookie principal
'       Se não definido utiliza caminho especificado na constante 'defaultCookieName'
'
'==================================================================================
'   Definições e Declarações Globais
'==================================================================================
    If Not IsTest Then
